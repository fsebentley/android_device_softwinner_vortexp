...
static int hwc_setcolorkey(sun5i_hwc_context_t  *ctx)
{
    int                          fbfh0;
...
static int hwc_requestlayer(sun5i_hwc_context_t *ctx,uint32_t screenid)
{
...
{
    sun5i_hwc_context_t           *ctx = (sun5i_hwc_context_t *)dev;
    sun5i_hwc_layer_t            *curlayer = (sun5i_hwc_layer_t *)&ctx->hwc_layer;
...
static int hwc_setrect(sun5i_hwc_context_t *ctx,hwc_rect_t *croprect,hwc_rect_t *displayframe)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
static int hwc_setlayerframepara(sun5i_hwc_context_t *ctx,uint32_t value)
{
...
static int hwc_setlayerpara(sun5i_hwc_context_t *ctx,uint32_t value)
{
...
static int hwc_show(sun5i_hwc_context_t *ctx,int value)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
// for taking photo to avoid preview wrong
static int hwc_reqshow(sun5i_hwc_context_t *ctx,int value)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
// for taking photo to avoid preview wrong
static int hwc_release(sun5i_hwc_context_t *ctx)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
static int hwc_setformat(sun5i_hwc_context_t *ctx,uint32_t value)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
static int hwc_setscreen(sun5i_hwc_context_t *ctx,uint32_t value)
{
    int                         fd;
    __disp_layer_info_t         layer_info;
    int                         ret;
...
// for taking photo to avoid preview wrong
static int hwc_vppon(sun5i_hwc_context_t *ctx,int value)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
// for taking photo to avoid preview wrong
static int hwc_getvppon(sun5i_hwc_context_t *ctx)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
// for taking photo to avoid preview wrong
static int hwc_setlumasharp(sun5i_hwc_context_t *ctx,int value)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
// for taking photo to avoid preview wrong
static int hwc_getlumasharp(sun5i_hwc_context_t *ctx)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
// for taking photo to avoid preview wrong
static int hwc_setchromasharp(sun5i_hwc_context_t *ctx,int value)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
// for taking photo to avoid preview wrong
static int hwc_getchromasharp(sun5i_hwc_context_t *ctx)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
// for taking photo to avoid preview wrong
static int hwc_setwhiteexten(sun5i_hwc_context_t *ctx,int value)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
// for taking photo to avoid preview wrong
static int hwc_getwhiteexten(sun5i_hwc_context_t *ctx)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
// for taking photo to avoid preview wrong
static int hwc_setblackexten(sun5i_hwc_context_t *ctx,int value)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
// for taking photo to avoid preview wrong
static int hwc_getblackexten(sun5i_hwc_context_t *ctx)
{
    uint32_t                    overlay;
    int                         fd;
    int                         ret = 0;
...
static int hwc_set3dmode(sun5i_hwc_context_t *ctx,int para)
{
    int                         ctl_fd;
    void                        *overlay;
    int                         fd;
        ...
        struct hw_device_t** device)
{
    ...
    {
        sun5i_hwc_context_t *dev;
        dev = (sun5i_hwc_context_t*)malloc(sizeof(*dev));
